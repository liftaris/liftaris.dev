    ...
    <section id="posts" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-12 flex items-center justify-between">
          ...
          <div className="hidden sm:flex sm:items-center sm:gap-2 sm:text-sm sm:text-muted-foreground">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {allBlogs &&
            ...
            allBlogs.map((post, index) => (
              <Card
                key={post.filename}
                className="group relative overflow-hidden border-border transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5"
              >
