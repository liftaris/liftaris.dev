/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 55eeb62668c6f7341722e881b830b6ba)
...
interface __BaseEnv_Env {
	...
	VISITOR_AUTH_SECRET: string;
	JEV_API_KEY: string;
	HOUSE: DurableObjectNamespace<import("./src/worker").House>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "House";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOUSE_OWNER_ID" | "EMDASH_SETUP_KEY" | "VISITOR_AUTH_SECRET" | "JEV_API_KEY">> {}
}
