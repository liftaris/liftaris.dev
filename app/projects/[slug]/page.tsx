...
import { GitHubLogoIcon, GlobeIcon, DiscordLogoIcon } from "@radix-ui/react-icons";
...
const PROJECTS: Record<string, ProjectData> = {
  bazaarghost: {
    name: "BazaarGhost",
    tagline: "See how your ghost performs against Twitch streamers in The Bazaar",
    description: [
    ...
    screenshot: "/images/bazaarghost-screenshot.svg"
  },
  shaderweb: {
    name: "ShaderWeb",
    ...
    screenshot: "/images/shaderweb-screenshot.svg"
  },
  "hnswlib-wasm": {
    name: "hnswlib-wasm",
        ...
        {project.stats && (
          <Card className="p-4 grid grid-cols-2 gap-4">
            ...
            {project.stats.activity && (
              <div>
                <div className="text-2xl font-bold">{project.stats.activity}</div>
